              ...
              <div className="col-md-6">
                <div className="ps-md-4">
                  <p className="lead mb-4">
                    At Delicious Bites, we serve the freshest and most flavorful
                    dishes, crafted with passion and love. Our commitment to
                    quality and exceptional service makes every visit memorable.
                  </p>
                  <div className="d-flex align-items-center mb-3">
                    <i className="fas fa-utensils text-danger me-3 fa-lg"></i>
                    <span className="h6 mb-0">
                      Authentic cuisine made with love
                    </span>
                  </div>
                  <div className="d-flex align-items-center mb-3">
